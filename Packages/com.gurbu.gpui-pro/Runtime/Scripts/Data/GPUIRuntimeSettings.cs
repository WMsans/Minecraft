...
#if UNITY_EDITOR
            bool isAndroidVulkan = EditorUserBuildSettings.activeBuildTarget is BuildTarget.Android && GraphicsDeviceType is GraphicsDeviceType.Vulkan;
#else
            bool isAndroidVulkan = Application.platform is RuntimePlatform.Android && GraphicsDeviceType is GraphicsDeviceType.Vulkan;
#endif
            DisableShaderBuffers = isAndroidVulkan || GraphicsDeviceType is not (
